...
<head>
    ...
    <script src="https://kit.fontawesome.com/0dcc6f6402.js" crossorigin="anonymous"></script>
    <!-- Fonts -->
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <div class="container">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('shipments') }}">
                                    {{ __('Shipments') }}
                                </a>
                                ...
                                <a class="dropdown-item" href="{{ route('governorates') }}">
                                    {{ __('Governorates') }}
                                </a>
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('newCheck') }}">
                        {{ __('New check') }}
                    </a>
                </div> -->
                        @endguest
